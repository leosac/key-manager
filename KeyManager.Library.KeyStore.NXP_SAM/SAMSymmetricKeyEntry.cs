    ...
    public class SAMSymmetricKeyEntry : KeyEntry
    {
        ...
        public override IList<KeyEntryVariant> GetAllVariants(KeyEntryClass? classFilter)
        {
            ...
            if (classFilter == null || classFilter == KeyEntryClass.Symmetric)
            {
                ...
                mfvar.KeyContainers.Add(new KeyVersion("Key Version A", 0, new Key(new[] { "MIFARE", KeyEntryClass.Symmetric.ToString() }, 6, new KeyMaterial(string.Empty, "Key A"), new KeyMaterial("00", "Key A Div KeyNo", 1) { ValidatePolicies = false }, new KeyMaterial("00", "Key A Div KeyVer", 1) { ValidatePolicies = false }, new KeyMaterial(string.Empty, "Key B"), new KeyMaterial("00", "Key B Div KeyNo", 1) { ValidatePolicies = false }, new KeyMaterial("00", "Key B Div KeyVer", 1) { ValidatePolicies = false })));
                mfvar.KeyContainers.Add(new KeyVersion("Key Version B", 0, new Key(new[] { "MIFARE", KeyEntryClass.Symmetric.ToString() }, 6, new KeyMaterial(string.Empty, "Key A"), new KeyMaterial("00", "Key A Div KeyNo", 1) { ValidatePolicies = false }, new KeyMaterial("00", "Key A Div KeyVer", 1) { ValidatePolicies = false }, new KeyMaterial(string.Empty, "Key B"), new KeyMaterial("00", "Key B Div KeyNo", 1) { ValidatePolicies = false }, new KeyMaterial("00", "Key B Div KeyVer", 1) { ValidatePolicies = false })));
                mfvar.KeyContainers.Add(new KeyVersion("Key Version C", 0, new Key(new[] { "MIFARE", KeyEntryClass.Symmetric.ToString() }, 6, new KeyMaterial(string.Empty, "Key A"), new KeyMaterial("00", "Key A Div KeyNo", 1) { ValidatePolicies = false }, new KeyMaterial("00", "Key A Div KeyVer", 1) { ValidatePolicies = false }, new KeyMaterial(string.Empty, "Key B"), new KeyMaterial("00", "Key B Div KeyNo", 1) { ValidatePolicies = false }, new KeyMaterial("00", "Key B Div KeyVer", 1) { ValidatePolicies = false })));
                variants.Add(mfvar);
            }
