...
{
    public class SAM_SESymmetricKeyEntryAuthenticationUIFactory : KeyEntryUIFactory
    {
        public SAM_SESymmetricKeyEntryAuthenticationUIFactory()
        {
            targetFactory = new SAM_SESymmetricKeyEntryAuthenticationFactory();
        }
        ...
        {
            return new SAM_SESymmetricKeyEntryAuthenticationPropertiesControl();
        }

        public override KeyEntryPropertiesControlViewModel CreateKeyEntryPropertiesControlViewModel()
        {
            return new SAM_SESymmetricKeyEntryAuthenticationPropertiesControlViewModel();
        }
    }
}
