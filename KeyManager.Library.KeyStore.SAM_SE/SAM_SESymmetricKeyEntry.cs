...
** Description: This file generate a Key Entry, an objet inherited from Key Manager.
** Licence: LGPLv3
    ...
    public class SAM_SESymmetricKeyEntry : KeyEntry
    {
        ...
        public override IList<KeyEntryVariant> GetAllVariants(KeyEntryClass? classFilter = null)
        {
            ...
            if (classFilter == null || classFilter == KeyEntryClass.Symmetric)
            {
                ...
                DESFirevar.KeyContainers.Add(new KeyContainer(Resources.KeyValue, new Key(new string[] { "AES", KeyEntryClass.Symmetric.ToString() }, 16)));
