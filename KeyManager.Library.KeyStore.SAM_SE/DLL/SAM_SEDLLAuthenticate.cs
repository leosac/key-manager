...
{
    public class SAM_SEDllAuthenticate(UIntPtr ctx, string stringID, uint id, SAM_SESymmetricKeyEntryProperties.SAM_SEKeyEntryType type) : SAM_SEDllObject(ctx, stringID, id, type)
    {
